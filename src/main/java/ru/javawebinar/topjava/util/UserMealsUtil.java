...
public class UserMealsUtil {
    ...
    public static List<UserMeal> MEAL_LIST_2 = Arrays.asList(
            ...
            new UserMeal(LocalDateTime.of(2015, Month.MAY, 31, 10, 0), "Завтрак2", 9000),
            new UserMeal(LocalDateTime.of(2015, Month.MAY, 31, 13, 0), "Обед2", 400),
            new UserMeal(LocalDateTime.of(2015, Month.MAY, 31, 20, 0), "Ужин2", 410)
    );
