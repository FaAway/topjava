...
public class UserTestData {
    ...
    public static final int TEST_USER_ID = START_SEQ + 2;
    ...
    public static final User TEST_USER = new User(TEST_USER_ID, "TestUser", "test@gmail.com", "testtest", 2000, Role.ROLE_USER);
